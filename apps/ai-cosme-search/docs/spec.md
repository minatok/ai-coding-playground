...
#### カラートーン（共通UI）
- **Primary**: #2EB6AA（ボタン・ヘッダー）、ホバー/アクティブに #00A699。
- **Background Accent**: #A5DEDA / #DBF1F0（カードやセクションのグラデーション）。
- **System Gray**: メインテキスト #233838、サブテキスト #556666、補助 #798989、ラベル #99A3A3。
- **Attention**: #FF3333（価格や警告系）。
- **Review Star**: #AA8800。
- キーワードチップやレビュー要約などは上記グレー+ティールの組み合わせで統一。
